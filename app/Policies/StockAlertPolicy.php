...
final class StockAlertPolicy
{
     ...
     */
    public function restore(User $user, StockAlert $stockAlert): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, StockAlert $stockAlert): bool
    {
        return false;
    }
}
