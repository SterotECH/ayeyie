...
<ui-disclosure data-flux-navlist-group {{ $attributes->class('group/disclosure') }}
    ...
    <button
        class="group/disclosure-button mb-[2px] flex h-10 w-full items-center rounded-lg text-zinc-500 hover:bg-zinc-800/5 hover:text-zinc-800 lg:h-8 dark:bg-zinc-800/[7%] dark:text-white/80 dark:hover:bg-zinc-50 dark:hover:text-white"
        type="button">
        <div class="pl-3 pr-4">
